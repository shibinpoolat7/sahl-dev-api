...
class Vehicle(models.Model):
    ...
    daily_min_rate = models.DecimalField(max_digits=5, decimal_places=2)
    daily_max_rate = models.DecimalField(max_digits=5, decimal_places=2)
    monthly_min_rate = models.DecimalField(max_digits=5, decimal_places=2)
    monthly_max_rate = models.DecimalField(max_digits=5, decimal_places=2)
